...
{
    public class Entsäuerungst2Controller : ApiController
    {
        public EntsäuerungResponse Post([FromBody] request_Entsäuerung param)
        {
            ...
            try
            {
                ...
                double e6 = Convert.ToDouble(param.em2) * ((gs2_1d - e4) / (gs2_1d - 2));    //E3
                double e7 = Convert.ToDouble(param.em2) * ((gs2_1d - e4) / (gs2_1d - 3));    //E4
